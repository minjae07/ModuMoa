      ...
      $("#search").click(function() {
        ...
        $.ajax({
          ...
          success: function(data) {
            ...
            word += "<th class='collection'>분류</th>";
            word += "<th class='thumbnail_url'>미리보기</th>";
            word += "<th class='display_sitename'>출처</th>";
            ...
            $.each(data.documents,function(index, obj){
	            ...
	            var thumbnail_url = obj.thumbnail_url;
	            var image_url = obj.image_url;
	            var display_sitename = obj.display_sitename;
	            var datetime = obj.datetime.split("T")[0]; 
	            var doc_url = obj.doc_url;
	            ...
	            word += "<td><a href='" + doc_url + "' target='_blank'>" + collection + "</a></td>";
	            word += "<td><img src='" + thumbnail_url + "'></td>";
	            if (display_sitename == "") {
	                word += "<td>외부 사이트</td>";
	            } else {
	                word += "<td>" + display_sitename + "</td>";
	            }
	            word += "<td>" + datetime + "</td>";
	            word += "</tr>";
...
<div class="sidebar">
	      ...
	      <h3 style="text-align:center;">빠른 이미지검색</h3>
